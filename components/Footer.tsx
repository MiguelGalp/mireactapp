...
export const Footer: React.FC<{
  ...
  return (
    <footer className={styles.footer}>
     ...
     <div className={styles.titulo}><p><span className={styles.recuadro}>un jardín digital</span> comunitario ✦ somos una ong tech para otras ongs, organizaciones, proyectos, ideas y expresiones artísticas<span className={styles.estrellas}> ✦</span> cultivamos juntos un laboratorio de <span className={styles.recuadro}>herramientas</span> digitales para tus redes sociales, tu público y tus acciones educativas y de capacitación ✧ <a href="mailto:miguel.galperin@gmail.com"><span className={styles.recuadro}>escribinos</span></a> para una demo ✧ whatsapp ✧ instagram ✦ 2022 copyright atlanticx.org ➠</p></div>
