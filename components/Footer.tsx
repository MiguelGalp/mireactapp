...
export const Footer: React.FC<{
  ...
  return (
    <footer className={styles.footer}>
     ...
     <div className={styles.titulo}><p>estudio web ✦ el color es tuyo <br /> diseño ✧ procesos ✦ deploy<br />✦ comunidades ✦ eventos <br />educación ✦ cultura ✦ ux/ui ✦ <br />web studio ✦ el color es tuyo<br />✧ design ✦ projects ✦ deploy <br />communities ✦ virtual events ✦<br />education ✧ culture ✧ ux/ui<br />agência web ✧ el color es tuyo<br /> design ✦ projetos ✦ deploy <br />comunidades ✦ eventos virtuais<br />educação ✦ cultura ✦ ux/ui ✦ <br /> estudio web ✦ el color es tuyo <br /> diseño ✦ procesos ✦ deploy<br />✦ comunidades ✦ eventos <br />educación ✦ cultura ✦ ux/ui ✦ </p></div>
