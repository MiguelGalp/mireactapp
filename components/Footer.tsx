...
export const Footer: React.FC<{
  ...
  return (
    <footer className={styles.footer}>
     ...
     <div className={styles.titulo}><p>jardín digital ✦ el color es tuyo <br /> diseño ✧ desarrollo ✦ deploy web3<br />✦ comunidades online ✦ educación <br />tus eventos ✦ tu cultura ✦ ux/ui<br />para tu control ✦ integraciones<br />✧ tu nueva herramienta ✦ tienda <br />suscripciones ✦ campañas ✦ color <br /> proyectos ✧ identidades ✧ redes<br />contenidos ✧ experiencias ✦ usos <br /> escribinos ✦ correo ✦ instagram <br />whatsapp ✦ twitter ✧ facebook<br />somos músicos ✦ el color es tuyo <br /> diseño ✦ desarrollo ✦ deploy web3<br />comunidades ✦ eventos ✧ educación <br />cultura ✦ ux/ui ✦ jardín digital</p></div>
